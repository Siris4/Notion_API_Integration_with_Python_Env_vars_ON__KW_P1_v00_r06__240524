...
# Read Notion API key, page ID, and ChromeDriver path from environment variables
...
# Use the path to the manually downloaded ChromeDriver from environment variable
try:
